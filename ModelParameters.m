% Parameters from Cone and Shouval's model
...
l23_rec = .00000;
l5_l23 = .0002; %.0002
l23_l5 = .00000000000000000002;%.4; %DO NOT SET TO ZERO OR FF IDENTITY WILL BE WRONG
i_l5_rec = .0001;
i_l23_rec = .000;
i_l5_l23 = .07;%.05
i_l23_l5 = 0;
...
T_max_d1 = .0045;% T_max_d1 = .0034; %maximum eligibility trace for LTD
eta_p1 = 8.8*3500;% eta_p1 = 25*3000; %
eta_d1 = 10*3500;% eta_d1 = 15*3000; %
